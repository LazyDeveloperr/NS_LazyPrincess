...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.answer('❤️Thank You @LazyDepveloper ❤️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/LazyDepveloper')
        ], [
    ...
    await query.answer('❤️Thank You @LazyDepveloper ❤️')
